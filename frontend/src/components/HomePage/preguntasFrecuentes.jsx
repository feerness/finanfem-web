...
const PreguntasFrecu = () => {
  ...
  const faqs = [
    ...
    {
      question:
        "¿Las finanzas personales son solo para personas con mucho dinero?",
      answer:
    ...
    {
      question:
        "¿Qué tan importante es entender sobre finanzas si no tengo planes de invertir?",
      answer:
  ...
  return (
    <div className="container-preg" id="qa">
